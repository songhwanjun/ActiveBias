...
## 2. Setup and Network Architecture
- To validate the superiority of *Active Bias*, we show the test error on a simulated noisy CIFAR-10, which has mislabeled samples.
